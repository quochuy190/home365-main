...
public class AdapterCurrentExer extends RecyclerView.Adapter<AdapterCurrentExer.TopicViewHoder> {
    ...
    public AdapterCurrentExer(List<Baitap_Tuan> listAirport, Context context) {
    ...
    public TopicViewHoder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_current_exer, parent, false);
