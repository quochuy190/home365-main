...
public class Constants {
    ...
    public static final String PHONE_VIP = "PHONE_VIP";
    public static final String PASSWORD_VIP = "PASSWORD_VIP";
    public static final String PARENTID_VIP = "PARENTID_VIP";
    public static final String USERCHILD_VIP = "USERCHILD_VIP";
